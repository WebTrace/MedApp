<?Php
    class Branch extends My_Controller
    {
        public function index()
        {
            ...
            $this->load->view("app/branch/branches", $data);
        ...
        */
        ...
        public function branch_404()
        {
            ...
            $this->load->view("app/branch/branch_404");
            $this->load->view("app/templates/auth-footer");
        }
        ...
        public function update_branch($branch_id)
        {
            ...
            $this->load->view("app/templates/header");
            $this->load->view("app/branch/update", $data);
            $this->load->view("app/templates/footer");
        }
        ...
        public function branch_settings($branch_id)
        {
            ...
            $this->load->view("app/templates/header");
            $this->load->view("app/branch/settings", $data);
            $this->load->view("app/templates/footer");
        }
        ...
        public function fetch_working_hours($branch_id)
        {
            ...
            $this->load->view("app/templates/header");
            $this->load->view("app/branch/working-hours", $data);
            $this->load->view("app/templates/footer");
