                    ...
                    <tbody>
                        <?Php foreach($patients as $patient) : ?>
                            <tr class="patient-details" data-target="<?Php echo $patient['patient_id']; ?>">
                                ...
                                <?Php endif; ?>
                                <td><a style="font-size: 15px; color: #eeaa4f;" class="" href="<?Php echo base_url()?>patient/patient_file/<?Php echo $patient['file_no']; ?>" title="Pull patient file: <?Php echo $patient['file_no']; ?>"><i class="fa fa-fw fa-folder-open-o"></i></a></td>
