<div class="row menu-row">
    ...
    <div class="col-lg-6">
        <ul class="nav-controls pull-right">
            ...
            <li>
                <a href="<?Php echo base_url(); ?>appointment/waiting" class="link-menu" id="add-appointment"><i class="fa fa-wheelchair"></i> Waiting room</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="col-lg-4">
                        <a href="#" class="appointment-item" data-toggle="modal" data-target="#patient-app-details">
                            <div class="app-item-header">
                                <h5><?Php echo $appointment['first_name'] . " " . $appointment['last_name']; ?></h5>
                            </div>
                            <hr style="margin: 0px;">
                            <div class="app-item-body">
                                ...
                                <p>
                                    ...
                                    <span class="app-data"><i class="fa fa-clock-o"></i> <?Php echo $appointment['appointment_time']; ?></span>
                                </p>
                                <p>
                                ...
                                <div class="col-lg-6">
                                    <div class="app-field-group">
                                        ...
                                        <select name="branch_service" class="app-input-field" id="branch-service">
                                            ...
                                            <option value="<?Php echo ANY_SERVICE; ?>">Any service</option>
