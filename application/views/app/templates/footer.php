        ...
        <script src="<?Php echo base_url()?>assets/app/libs/datepicker/js/bootstrap-datepicker.min.js"></script>
        
        <!-- Bootstrap Core JavaScript -->
        <script src="<?Php echo base_url()?>assets/app/js/bootstrap.min.js"></script>
        <script src="<?Php echo base_url()?>assets/app/js/morris.min.js"></script>
        <script src="<?Php echo base_url()?>assets/app/js/raphael.min.js"></script>
