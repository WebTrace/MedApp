            ...
            <div class="tab-pane" id="fi-patient-info">
                <div class="row">
                    <div class="col-lg-6 border-right">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 style="float: left;" class="edit-details-header">Personal details</h4>
                                <ul class="fi-sub-menu">
                                    <li><a id="pe-save" href="#"><span style="font-size: 11px;"><i class="fa fa-floppy-o"></i></span></a></li>
                                </ul>
                            </div>
                        </div>
                        <?Php echo form_open(base_url() . "patient/update/personal", array("id" => "pe-info-update")); ?>
                            ...
                            <div class="row edit-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit-input-grouper">
                                        ...
                                        ?>
                                        <input type="text" name="middle_name" class="edit-input" value="<?Php echo $middle_name; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row edit-group">
                            ...
                            <div class="row edit-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit-input-grouper">
                                        <span class="edit-data-icon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" name="dob" class="edit-input" value="<?Php echo $patient_details['dob']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row edit-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit-input-grouper">
                                        <span class="edit-data-icon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" name="idno" class="edit-input" value="<?Php echo $patient_details['id_number']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row edit-group">
                            ...
                            <div class="row edit-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="edit-input-grouper">
                                        <span class="non-edit-data-icon"><i class="fa fa-lock"></i></span>
                                        <input type="text" disabled="disabled" name="gender" class="edit-input" value="<?Php echo $patient_details['gender']; ?>">
                                    </div>
                                </div>
                             </div>
                            ...
                            <div class="col-lg-8">
                                <div class="edit-input-grouper">
                                    <span class="edit-data-icon"><i class="fa fa-pencil"></i></span>
                                    <input style="border-bottom: none;" type="text" name="ethnic" class="edit-input" value="<?Php echo $patient_details['ethnic_group']; ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row edit-group">
                                    <div class="col-lg-12">
                                        <h4 style="float: left;" class="edit-details-header">Work details</h4>
                                        <ul class="fi-sub-menu">
                                            <li><a href=""><span style="font-size: 11px;"><i class="fa fa-floppy-o"></i></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row edit-group">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 style="float: left;" class="edit-details-header">Contact details <!--<a title="Add new contact" href="#" class="pull-right add-patient-field"><i class="fa fa-plus"></i></a>--></h4>
                                        <ul class="fi-sub-menu">
                                            <li><a href=""><span style="font-size: 11px;"><i class="fa fa-floppy-o"></i></span></a></li>
                                            <li><a href="#" id="add-new-contact"><span style="font-size: 11px;"><i class="fa fa-plus"></i></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row edit-group">
