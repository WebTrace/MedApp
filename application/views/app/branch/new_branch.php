<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div style="margin: 60px 0px 0px" class="header-sec">
                            ...
                            <?Php echo form_open(base_url() . "setup/branch/new", array('id' => 'create_new_practice')); ?>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="practice_name" class="reg-label">Practice name</label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="tel_number" class="reg-label">Tel number</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="practice_email" class="reg-label">Practice email</label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="address_line" class="reg-label">Address line 1</label>
                                                <input type="text" name="address_line" class="reg-input" id="address_line" placeholder="Address line 1">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="suburb" class="reg-label">Suburb</label>
                                                <input type="text" name="suburb" class="reg-input" id="surbub" placeholder="Suburb">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="postal_code" class="reg-label">Postal code</label>
                                                <input type="text" name="postal_code" class="reg-input" id="city" placeholder="Postal code">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="reg-group">
                                            <div class="inp-collection">
                                                <label for="province" class="reg-label">Province</label>
