<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <div class="acc-payment-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="upgrade-header">Select account type</h4>
                </div>
                ...
                <div class="col-lg-12">
                    <?Php echo form_open(base_url() . '', array('id' => '')); ?>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="account-group-display">
                                    <p class="acc-display acc-price-display">R <?Php echo $account_type['price']; ?> | <span><?Php echo $account_type['name']; ?></span></p>
                                    <p class="acc-display acc-name-display"></p>
                                    <p class="acc-display"><?Php echo $account_type['description']; ?></p>
                                    <span class="acc-selected"><i class="fa fa-check-circle-o"></i></span>
