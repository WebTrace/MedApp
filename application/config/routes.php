...
$route['patient/search']                            = 'admin/patient/patient_app_search';
$route['patient/single']                            = 'admin/patient/fetch_single_patient';
...
$route['patient/billing/type']                      = 'admin/billing/patient_billing_type';
...
$route['practitioner/service']                      = 'admin/practitioner/fetch_service_practiotner';
$route['branch/practitioners']                      = 'admin/practitioner/fetch_branch_practitioner';
$route['branch/services/(:any)']                    = 'admin/services/update_services/$1';
$route['branch/schedular/(:any)']                   = 'admin/schedular/schedular_settings/$1';
